...
struct DecorDefinition Level_Template_Decor[] = {
    ...
    {{-1500, 0, -3200}, {8.9407e-08, 0.184693, -1.49012e-08, 0.982796}, 1, SEARCHLIGHT_DECOR_ID},
    {{-1851.11, 0, -1730.78}, {0, 0.996393, 0, 0.0848587}, 1, DISHBASE_DECOR_ID},
    {{-146.485, 136.501, -1530.49}, {0, 0, 0, 1}, 1, DISH_DECOR_ID},
    {{-48.5003, 0, -3712.41}, {0, 0, 0, 1}, 1.28005, BROKEN_BASE_DECOR_ID},
    {{-1924.5, 0, -2575.11}, {0, 0, 0, 1}, 1, CONSOLES_DECOR_ID},
};

...
struct DecorDefinition Course_01_Decor[] = {
    ...
    {{-2153.39, 136.501, -3486.53}, {0, 0, 0, 1}, DISH_DECOR_ID},
    {{2323.11, 136.501, 929.481}, {-1.11759e-08, 0.992333, -1.19209e-07, -0.123593}, DISH_DECOR_ID},
};
...
struct LevelDefinition Course_01_Definition = {
    ...
    .pathfinding = {.nodeCount = 0, .baseNodes = Course_01_BasesPathNodes, .baseDistances = Course_01_basePathNodeDistnaces, .nodePositions = Course_01_PathingNodes, .nextNode = Course_01_NextNode},
};

...
struct BaseDefinition Orion_Bases[] = {
    {.position = {-1858.31, 4590.83}, .startingTeam = TEAM(0)},
    {.position = {1393.73, -4897.41}, .startingTeam = TEAM(1)},
    {.position = {-3000.39, -5491.22}, .startingTeam = TEAM(2)},
    {.position = {3077.82, 3667.95}, .startingTeam = TEAM(3)},
    {.position = {-167.867, -483.934}, .startingTeam = TEAM_NONE},
    {.position = {393.496, -967.867}, .startingTeam = TEAM_NONE},
    {.position = {-864.732, 38.7147}, .startingTeam = TEAM_NONE},
};
...
struct DecorDefinition Orion_Decor[] = {
    ...
    {{523.037, 0, 3142.32}, {-8.9407e-08, -0.459793, -2.98023e-08, 0.888026}, 1, ROCK003_DECOR_ID},
    ...
    {{-677.118, 0, -2993.96}, {0, -0.147572, 0, 0.989051}, 0.8267, ROCK003_DECOR_ID},
...
struct Vector3 Orion_PathingNodes[] = {
    {-867.803, 0.0f, 45.1152},
    {-3013.24, 0.0f, -5465.17},
    {1400.13, 0.0f, -4884.45},
    {-141.902, 0.0f, -503.343},
    {438.819, 0.0f, -1019.54},
    {-1851.8, 0.0f, 4626.36},
    {3100.46, 0.0f, 3674.62},
    {1706.62, 0.0f, -690.36},
};
...
unsigned short Orion_NodeDistances[] = {
    0, 5913, 5554, 909, 1686, 4685, 6198, 9759, 
    5913, 0, 4451, 5732, 6509, 10158, 11021, 8656, 
    5554, 4451, 0, 4644, 3982, 10051, 8787, 4205, 
    909, 5732, 4644, 0, 776, 5407, 5288, 8849, 
    1686, 6509, 3982, 776, 0, 6184, 5396, 8187, 
    4685, 10158, 10051, 5407, 6184, 0, 5042, 9625, 
    6198, 11021, 8787, 5288, 5396, 5042, 0, 4582, 
    9759, 8656, 4205, 8849, 8187, 9625, 4582, 0, 
};
char Orion_NextNode[] = {
    0, 1, 3, 3, 3, 5, 3, 3, 
    0, 1, 2, 3, 3, 5, 3, 2, 
...
struct LevelDefinition Orion_Definition = {
    ...
    .pathfinding = {.nodeCount = 8, .baseNodes = Orion_BasesPathNodes, .nodeDistances = Orion_NodeDistances, .nodePositions = Orion_PathingNodes, .nextNode = Orion_NextNode},
};

...
struct DecorDefinition Sojourner_2_Decor[] = {
    {{5858.53, 0, -4635.33}, {5.96046e-08, -0.465219, -2.53569e-08, 0.885195}, ROCK001_DECOR_ID},
    {{3483.19, 0, -184.614}, {0, -1, 0, -4.37114e-08}, ROCK003_DECOR_ID},
    {{-1500, -25.934, -3600}, {-0.0211762, -0.999776, 8.98698e-08, -4.19095e-08}, CRATE_DECOR_ID},
    {{1901.04, 0, -4300.97}, {0, -1, 0, -4.37114e-08}, BROKEN_BASE_DECOR_ID},
    {{-1053.37, 0, -729.333}, {-6.02007e-06, 0.704794, 5.94617e-06, 0.709412}, CONSOLES_DECOR_ID},
    {{1700.87, -15.7789, -2054.32}, {0.187961, -0.860551, -0.424759, -0.209053}, DISH_DECOR_ID},
    {{1868.34, 13.3598, -2465.25}, {0, -1, 0, -4.37114e-08}, DISHBASE_DECOR_ID},
    {{-1589.22, 0, -3059.83}, {-8.9407e-08, -0.802802, 1.6771e-08, -0.596246}, SEARCHLIGHT_DECOR_ID},
    {{5821.7, 0, 4565.69}, {-0.46522, 8.9407e-08, -0.885195, -1.49012e-08}, ROCK001_DECOR_ID},
    {{-5926.44, 0, -4635.33}, {-0.885195, 4.47035e-08, 0.465219, 1.19209e-07}, ROCK001_DECOR_ID},
    {{-5926.44, 0, 4486.93}, {-1.49012e-08, -0.885195, -1.01677e-08, -0.465219}, ROCK001_DECOR_ID},
    {{-3380.7, 0, -184.614}, {0, -1, 0, -4.37114e-08}, ROCK003_DECOR_ID},
    {{199.174, 0, -2669.81}, {-8.9407e-08, -0.707107, -4.41503e-08, 0.707107}, ROCK003_DECOR_ID},
    {{199.174, 0, 2211.83}, {0.707107, -2.98023e-08, -0.707107, -8.9407e-08}, ROCK003_DECOR_ID},
    {{-2048.21, 0, 3126.99}, {0, -1, 0, -4.37114e-08}, BROKEN_BASE_DECOR_ID},
    {{-5414.94, 0, -2190.3}, {-0.954073, -2.98023e-08, -0.299574, 1.49012e-07}, CONSOLES_DECOR_ID},
    {{5316.34, 0, 1871.48}, {-8.9407e-08, 0.345789, 2.05075e-08, 0.938312}, CONSOLES_DECOR_ID},
    {{2107.44, -15.7789, 1964.69}, {-0.456194, 0.318228, 0.0873893, 0.826427}, DISH_DECOR_ID},
    {{2433.33, 13.3598, 2265.86}, {2.98023e-08, 0.569484, -1.18369e-08, 0.822003}, DISHBASE_DECOR_ID},
    {{-5014.72, -15.7789, 2101.25}, {-0.448607, 0.377646, 0.120424, 0.80102}, DISH_DECOR_ID},
    {{-4648.5, 13.3598, 2351.82}, {-5.96046e-08, 0.62791, 4.68123e-08, 0.778286}, DISHBASE_DECOR_ID},
    {{4927.22, -15.7789, -2080.76}, {-0.448607, 0.377646, 0.120424, 0.80102}, DISH_DECOR_ID},
    {{5293.44, 13.3598, -1830.2}, {-5.96046e-08, 0.62791, 4.68123e-08, 0.778286}, DISHBASE_DECOR_ID},
    {{-1678.18, -100.308, -2968.94}, {0.185057, -0.927762, -0.317856, 0.0630766}, CRATE_DECOR_ID},
    {{-2448.91, -61.3504, -3124.76}, {-0.0858776, -0.980231, 0.177569, 0.0155567}, CRATE_DECOR_ID},
    {{-2014.01, -26.032, 1409.58}, {0.0073719, -0.997876, 0.0559831, 0.032488}, CRATE_DECOR_ID},
    {{-2192.19, -60.5534, 2040.64}, {0.10708, -0.900834, -0.133745, -0.398928}, CRATE_DECOR_ID},
    {{-2962.92, -37.907, 1884.82}, {-0.0357999, -0.981428, 0.0766125, -0.172187}, CRATE_DECOR_ID},
    {{2913.78, 0, 3600.28}, {0, -1, 0, -4.37114e-08}, CRATE_DECOR_ID},
    {{2735.6, 0, 4231.34}, {0, -0.933086, 8.15465e-08, -0.359652}, CRATE_DECOR_ID},
    {{1964.87, 0, 4075.52}, {0, -0.97398, 3.47555e-08, 0.226633}, CRATE_DECOR_ID},
    {{3820.03, 0, -2511.25}, {-2.98023e-08, -0.875438, 1.08646e-07, -0.48333}, CRATE_DECOR_ID},
    {{3641.86, 0, -1880.19}, {7.45058e-09, -0.969675, -6.49462e-08, -0.2444}, CRATE_DECOR_ID},
    {{2871.12, 0, -2036.01}, {7.45058e-08, -0.892616, 1.88667e-07, 0.450819}, CRATE_DECOR_ID},
    {{-1589.22, 0, 2159.19}, {7.45058e-09, -0.983458, 2.58435e-08, -0.181136}, SEARCHLIGHT_DECOR_ID},
    {{3523, 0, -3059.83}, {0, -0.872128, -7.87135e-08, 0.489277}, SEARCHLIGHT_DECOR_ID},
    {{2182.42, 0, 3529.4}, {0, -0.872128, -7.87135e-08, 0.489277}, SEARCHLIGHT_DECOR_ID},
};
